...
<form class="form-horizontal" class="form-horizontal" action="editprod_action.php" method="post" enctype="multipart/form-data">
	...
	<label for="focusedinput" class="col-sm-2 control-label">Package Name</label>
		<div class="col-sm-4">
			<input type="text" class="form-control1" name="pname" id="pname" value="<?php echo $array1['pname'] ?>" autocomplete="off" placeholder=" Package Name" onchange="Validatename()"; required>
	...
	<label for="selector1" class="col-sm-2 control-label">Number of Adults</label>
		<div class="col-sm-4"><select name="adult" id="adult" value="<?php echo $array1['adult'] ?>" class="form-control1">
			<option value="0">Select no.of adults</option>
					...
					<div class="form-group">
									...
									<div class="col-sm-4"><select name="Childrens" id="Childrens" value="<?php echo $array1['Childrens'] ?>"class="form-control1">
					...
					<div class="form-group">
									...
									<div class="col-sm-4"><select name="day" id="day" value="<?php echo $array1['day'] ?>"class="form-control1">
						...
						<div class="form-group">
									...
									<div class="col-sm-4"><select name="night" id="night" value="<?php echo $array1['night'] ?>" class="form-control1">
...
<label for="focusedinput" class="col-sm-2 control-label">Stay Amount</label>
	<div class="col-sm-4">
	<input type="number" min="0" class="fg" name="price1" id="packageprice1" value="<?php echo $array1['price1'] ?>"size=20  placeholder="price" required>
	</div>

			<label for="focusedinput" class="col-sm-2 control-label">Food Amount</label>
			<div class="col-sm-4">
			<input type="number" min="0" class="fg" name="price2" id="packageprice2"value="<?php echo $array1['price2'] ?>" size=20  required>
		...
		<div class="form-group">
									...
									<input type="number" min="0" class="fg" name="price3" id="packageprice3" value="<?php echo $array1['price3'] ?>"size=20  placeholder="price" required>
							...
							<label for="focusedinput" class="col-sm-2 control-label">Car Amount</label>
									<div class="col-sm-4">
										...
										<input type="number" min="0" class="fg" name="price4" id="packageprice4" value="<?php echo $array1['price4'] ?>" size=20  placeholder="price" required>
...
<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<input type="number" min="0" class="fg" name="price5"  id="packageprice5" value="<?php echo $array1['price5'] ?>"size=20  placeholder="price" required>
