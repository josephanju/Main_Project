...
<form class="form-horizontal" class="form-horizontal" action="editprod_action1.php" method="post" enctype="multipart/form-data">
	<div class="form-group">
	<label for="focusedinput" class="col-sm-2 control-label">Package Name</label>
		<div class="col-sm-4">
			<input type="text" class="form-control1" name="pname" id="pname" value="<?php echo $array1['package_name'] ?>" autocomplete="off" placeholder=" Package Name" onchange="Validatename()"; required>
