...
?>
<?php
//$login_id=$_SESSION['unm'];
//$disp="SELECT  * FROM tble_package";

$disp="SELECT tble_package.*,tble_category.category_id,tble_category.category_name from tble_package,tble_category,tbl_login where tble_package.category_id=tble_category.category_id and tbl_login.login_id=tble_package.login_id and username='$unm' ";
//echo $login_id;
 ...
 ?>
  <tr>
	...
	?>
 	...
 	<td><?php echo $array['no_of_adults']+$array['no_of_childrens'];?>Travellers</td>
    
    <td><?php echo $array['no_of_days']+$array['no_of_nights'];?>Days</td>
    <td><?php echo $total;?></td>
    <td ><div style="width: 0px;height: 10px"><img style="width: 50px;height: 50px" src="packageimages/<?php echo $array['package_image']; ?>"></div></td>
    <td><a  style="background-color: green;color:white;padding: 10px"href="edit.php?pid=<?php echo $array['package_id'];?>">Edit</a></td>
