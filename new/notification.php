...
<table>
  ...
  <body>
  <?php
   $query=mysqli_query($con,"SELECT * FROM tble_messages AS m, tbl_login AS l, tble_package AS p, tble_category AS c WHERE m.login_id_user=l.login_id AND m.package_id=p.package_id AND p.category_id=c.category_id");
...
?>
<tr>
                               <td><font color="black"><?php echo $uname;?></font></td>
							   <td><?php echo $category;?></td>
                               <td><?php echo $package;?></td>
							   <td><?php echo $message;?></td>
							    <td><?php echo $time;?></td>
								<td><a href="../agency home/msg/index.php?id=<?php echo $id; ?>"><input type="button" value="Reply" class="button button1"></a></td>
								</tr> </form>
								<?php
							   }
								  }
