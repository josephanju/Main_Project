...
<!--heder end here-->
		<ol class="breadcrumb">
			<?php
					...
					?>
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a> <i class="fa fa-angle-right"></i> View Customers </li>
            </ol>
<!--four-grids here-->
		 <table class="table table-hover">
                              ...
                              <tbody>
                               <?php
								$result = mysqli_query($con,"SELECT  * FROM tbl_userreg,tbl_login where tbl_userreg.email_id=tbl_login.username"); 
                               ...
                               while($row=mysqli_fetch_array($result))
		                       {
							    ...
							    <tr>
								 ...
								 <td><a href="customerapproveaction.php?login_id='<?php echo $row['login_id'];?>'"><button><?php echo $up; ?></button></a></td>
							     <td><a href="customerapproveaction.php?login_id='<?php echo $row['login_id'];?>'"><button><?php echo $btn; ?></button></a></td>
								 </tr>
                                <?php
							    }	
								}
