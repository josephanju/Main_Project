...
include'../dbconnect.php';
		   ...
		   mysqli_query($con,"update tbl_login set password='".$newpassword."'  
		   where username='".$username."' AND password='".$currentpassword."'	");
				echo "<script>window.onload=function(){alert('Password updated sucessfully....!');window.location='../login/index.php';}</script>";		   
		   }
