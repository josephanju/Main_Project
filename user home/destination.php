...
<html lang="en">
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.php">CloudBerry<span>Hoildays</span></a>
        ...
        <div class="row">
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="#" class="img" style="background-image: url(newimg/1.jpg);">
        				<div class="text">
        					<h3>Ambalappuzha</h3>
        					<span>8 Tours</span>
        				</div>
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="#" class="img" style="background-image: url(newimg/mararikulam.jpg);">
        				<div class="text">
        					<h3>Cherthala</h3>
        					<span>2 Tours</span>
        				</div>
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="#" class="img" style="background-image: url(newimg/Chengannur-Mahadeva.jpg);">
        				<div class="text">
        					<h3>Chengannur</h3>
        					<span>5 Tours</span>
        				</div>
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="project-destination">
        			<a href="#" class="img" style="background-image: url(newimg/Mavelikara_Buddha.jpg);">
        				<div class="text">
        					<h3>Mavelikara</h3>
        					<span>5 Tours</span>
        				</div>
